...
public class UserRequestModelForMultipleTableData implements Serializable {
    ...
    public UserRequestModelForMultipleTableData(String request_id, String loan_request_code, String request_sender_user_name, String request_reciver_user_name, String request_sender_user_id, String request_reciver_user_id, String request_time_stamp, String request_is_seen, String req_status, String loan_due_date, String loan_duration, String loan_paid_out_date, String loan_status) {
