...
public class RequestLoanModel implements Serializable {
    ...
    public String loan_id, user_id, loan_request_code, user_full_name, user_img_url_request, loan_amount, loan_purpose, loan_collateral, loan_market_value, loan_type, loan_due_date, loan_doc_vehicle_id_url, loan_doc_owner_id_url, loan_doc_insurance_url;
