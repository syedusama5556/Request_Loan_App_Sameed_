...
public class RequestListShowAdapter_for_my_investments extends RecyclerView.Adapter<RequestListShowAdapter_for_my_investments.MyRequestViewHolder> {
    ...
    public RequestListShowAdapter_for_my_investments(Context context, ArrayList<RequestLoanModel> requestLoanModelArrayList, String ismyappliedloan) {
    ...
    public MyRequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyRequestViewHolder(LayoutInflater.from(context).inflate(R.layout.rec_requestlist_item_layout_for_my_investment, null));
    }
...
//                .skipMemoryCache(true).placeholder(R.mipmap.ic_launcher).into(holder.recImgProfile);
        ...
        holder.rec_loan_paidout_date.setText("Paid out Date: " + requestLoanModelArrayList.get(position).loan_paid_out_date);
                    ...
                    popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            if (item.getTitle().equals("View Full Data")) {
                                ...
                                Comman.showErrorToast(context, "Only Avaliable In the Market");
//
